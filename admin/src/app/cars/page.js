...
import { Plus, Search, Filter, Edit, Trash2, Eye, Car, Users, Calendar, MapPin } from 'lucide-react';
...
export default function CarsPage() {
  ...
  const filteredCars = cars.filter(car => {
    ...
    const matchesFilter = filterAvailability === "all" || car.availability === filterAvailability;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-ui-cards-gradient dark:bg-gray-800 rounded-xl p-6 shadow-lg text-white transition-all duration-300 group cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium  text-white dark:text-gray-400 group-hover:text-white/80">Total Vehicles</p>
              <p className="text-2xl font-bold text-white dark:text-white group-hover:text-white">{cars.length}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:bg-ui-cards-gradient hover:text-white transition-all duration-300 group cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-white/80">Available</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:bg-ui-cards-gradient hover:text-white transition-all duration-300 group cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-white/80">In Use</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white group-hover:text-white">
                {cars.filter(car => car.availability === "Unavailable").length}
              </p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:bg-ui-cards-gradient hover:text-white transition-all duration-300 group cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-white/80">This Month</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white group-hover:text-white">32</p>
            </div>
          ...
          <table className="w-full">
            <thead className="bg-secondary">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-white">Registration #</th>
        ...
        {totalPages > 1 && (
          <div className="bg-secondary px-6 py-3 flex items-center justify-between">
            <div className="text-sm text-white">
              Showing {Math.min(filteredCars.length, itemsPerPage)} of {filteredCars.length} entries
            </div>
            <div className="flex items-center space-x-2">
              <Button
