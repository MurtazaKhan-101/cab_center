  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      const fallbackVehicles = [
        {
          id: "economy",
          name: t("vehicles.economy") || "Economy",
        ...
        {
          id: "standard",
          name: t("vehicles.standard") || "Standard",
        ...
        {
          id: "first_class",
          name: t("vehicles.first_class") || "First Class",
          price: t("booking_form.price_per_km", { price: "120" }),
          farePerKm: 120,
        ...
        {
          id: "standard_van",
          name: t("vehicles.standard_van") || "Standard Van",
          price: t("booking_form.price_per_km", { price: "100" }),
          farePerKm: 100,
        ...
        {
          id: "minibus",
          name: t("vehicles.minibus") || "Minibus",
          price: t("booking_form.price_per_km", { price: "150" }),
          farePerKm: 150,
          image: "/images/Minibus 12 Pax.svg",
          seats: 12,
          capacity: t("booking_form.vehicle_capacity", { seats: "12" }),
        },
      ];
